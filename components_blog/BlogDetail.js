...
export default function BlogDetail({ initialBlogs }) {
  const hasData = initialBlogs && initialBlogs.length > 0;

  const displayBlogs = hasData
    ? initialBlogs.map((item) => ({
        id: item.slug || item._id,
        title: item.title,
        date: item.date || "May 28, 2026",
        readTime: "5 min read",
        author: "Harsh Vashishth",
        category: "Technology",
            ...
            <div className="relative z-10 flex flex-col items-center">
              <div className="w-16 h-16 rounded-full bg-emerald-500/10 border border-emerald-500/20 flex items-center justify-center text-emerald-400 mb-6 group-hover:scale-110 transition-transform duration-300">
                <svg className="w-8 h-8" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path strokeLinecap="round" strokeLinejoin="round" d="M19 20H5a2 2 0 01-2-2V6a2 2 0 012-2h10a2 2 0 012 2v1m2 4a2 2 0 00-2 2v3m2-7a2 2 0 012-2h1a2 2 0 012 2v7a2 2 0 01-2 2h-1a2 2 0 01-2-2V9z" />
                </svg>
              </div>
              ...
              <a href="#contact" className="inline-flex items-center gap-2 bg-emerald-500 hover:bg-emerald-400 text-black font-bold text-xs px-6 py-3 rounded-full transition-all duration-300 shadow-lg shadow-emerald-500/10 hover:shadow-emerald-500/25">
                Get in Touch
                <svg className="w-3.5 h-3.5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" d="M14 5l7 7m0 0l-7 7m7-7H3" /></svg>
              </a>
            </div>
          </div>
        ) : (
                    ...
                    <div className="hidden md:grid grid-cols-12 gap-6 p-6 items-center">
                      ...
                      <div className="col-span-8 flex flex-col justify-center p-4">
                        ...
                        <div>
                          ...
                          >
                            Read More
                            <svg xmlns="http://www.w3.org/2000/svg" className="h-3.5 w-3.5 transform group-hover/btn:translate-x-1 transition-transform duration-200" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2.5}>
                              <path strokeLinecap="round" strokeLinejoin="round" d="M14 5l7 7m0 0l-7 7m7-7H3" />
                            </svg>
                          </Link>
                        </div>
